[
    ...
    {trigger: "Nul([A-H])", replacement: "\\text{Nul [[0]]}$0", options: "rmA"},
    {trigger: "[cC]ol([A-H])", replacement: "$\\text{Col [[0]]}$", options: "rtA"},
    {trigger: "[cC]ol([A-H])", replacement: "\\text{Col [[0]]}", options: "rmA"},
    {trigger: "[rR]ow([A-H])", replacement: "$\\text{Row [[0]]}", options: "rt"},
    {trigger: "[rR]ow([A-H])", replacement: "\\text{Row [[0]]}", options: "rmA"},
    ...
    // You can edit snippet variales under the Advanced snippet settings section.
